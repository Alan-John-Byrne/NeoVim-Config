...
map("n", "<leader>bb", vim.config_utility.buffer_protection("e #"), { desc = "Switch to Other Buffer" })
map("n", "<leader>`", vim.config_utility.buffer_protection("e #"), { desc = "Switch to Other Buffer" })
map("n", "<leader>bd", vim.config_utility.buffer_protection("bd"), { desc = "Delete Buffer and Window" })
