...
return {
  {
    ...
    config = function()
      --  SECTION: 1. Setup Mason (UI-Based Package Manager), and Dap Virtual Text (Provides nice debugging variable value text notes.)
      ...
      -- SECTION: 2. Setup LSPs (Auto-Install + Auto-Config)
      ...
      -- SECTION: 3. Setup Linters & Formatters:
      ...
      -- SECTION: 4 Setup Debug Adapters (DAP)
      ...
      -- SECTION: 5. Setting up the Debug Adapter UI & Listeners for a better debug expierence.
      ...
      -- SECTION: 6. Setting nice icons for debug breakpoints.
      vim.fn.sign_define(
        "DapBreakpoint",
        { text = "●", texthl = "", linehl = "debugBreakpoint", numhl = "debugBreakpoint" }
      )

      -- SECTION: 7. Setup Tree-sitter (Language Parsing)
      -- PLUGIN: The 'nvim-treesitter' Part 1 - Configuration:
      -- This plugin provides better text highlighting, and also serves other core purposes for language support.
      ...
      -- SECTION: 8. Setting up Auto-Completions.
  ...
  -- PLUGIN: The 'nvim-treesitter' plugin Part 2 - Initialisation:
  -- This plugin provides better text highlighting, and also serves other core purposes for language support.
  {
