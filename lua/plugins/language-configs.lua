...
return {
	...
	dependencies = {
		...
		"nvimtools/none-ls-extras.nvim", -- null-ls-extras (Even More Linters & Formatters).
	...
	config = function()
		...
		null_ls.setup({
			sources = {
				...
				-- NOTE: Below is how you use 'null-ls-extras' extra formatters and linters:
